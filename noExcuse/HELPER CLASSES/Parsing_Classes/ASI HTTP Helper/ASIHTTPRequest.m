...
static NSTimeInterval defaultTimeOutSeconds = 50;
...
- (void)startRequest
{
    ...
    /*
    //New change as the HTTPS is not working in project
...

{
	...
	if (![self error]) { // We may already have handled this error
		...
		NSString *reason = @"Internet connection is not available, please check and try again";
