...
+ (void)dismiss
{
	if ([sharedDialog respondsToSelector:@selector(presentingViewController)])
        [[sharedDialog presentingViewController] dismissViewControllerAnimated:NO completion:nil];

	else
        [[sharedDialog parentViewController] dismissViewControllerAnimated:NO completion:nil];
}
